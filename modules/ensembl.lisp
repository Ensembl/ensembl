...
(defun ensembl-object-start (perl-object-name perl-caretaker-name caretaker-email)
  "Places standard ensembl object notation headers and footers"
  (interactive "sName of Object (no EnsEMBL): \nsName of caretaker: \nsEmail: ")
  ...
  (insert "\n# Let the code begin...\n\n")
  (insert "\npackage EnsEMBL::" perl-object-name ";\n")
