...
is($count, 22, 'Checking generic_count for protein_coding genes returns expected amounts');
...
my @ids = 1..256000;
my $id_derived_gene_list = $gene_adaptor->_uncached_fetch_all_by_id_list(\@ids, undef, "dbID", 1);
is(scalar(@{$id_derived_gene_list}), 23, 'Checking we get 23 genes back');
