...
) ENGINE=MyISAM AUTO_INCREMENT=685956 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=419 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=107 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `variation` (
  ...
  KEY `source_idx` (`source_id`)
) ENGINE=MyISAM AUTO_INCREMENT=79005735 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `variation_feature` (
  ...
  KEY `consequence_type_idx` (`consequence_types`),
  KEY `source_idx` (`source_id`)
) ENGINE=MyISAM AUTO_INCREMENT=88364514 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
