...
) ENGINE=MyISAM AUTO_INCREMENT=16033 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=529 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=198287 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=50869 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=20007 DEFAULT CHARSET=latin1;
...
CREATE TABLE `intron_supporting_evidence` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`)
) ENGINE=MyISAM AUTO_INCREMENT=126974 DEFAULT CHARSET=latin1;
...
INSERT INTO meta (species_id, meta_key, meta_value)
  VALUES (NULL, 'patch', 'patch_101_104_a.sql|schema_version');
...
CREATE TABLE `object_xref` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2562286 DEFAULT CHARSET=latin1;
...
CREATE TABLE `prediction_exon` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`)
) ENGINE=MyISAM AUTO_INCREMENT=272065 DEFAULT CHARSET=latin1;
...
CREATE TABLE `prediction_transcript` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`),
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=34643 DEFAULT CHARSET=latin1;
...
CREATE TABLE `protein_align_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `external_db_idx` (`external_db_id`)
) ENGINE=MyISAM AUTO_INCREMENT=272385 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
CREATE TABLE `protein_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4456776 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=227243 DEFAULT CHARSET=latin1;
...
CREATE TABLE `repeat_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2165456 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
CREATE TABLE `seq_region_synonym` (
  ...
  KEY `seq_region_idx` (`seq_region_id`)
) ENGINE=MyISAM AUTO_INCREMENT=3349 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=65083 DEFAULT CHARSET=latin1;
...
CREATE TABLE `transcript` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=35315 DEFAULT CHARSET=latin1;
...
CREATE TABLE `translation` (
  ...
  KEY `transcript_idx` (`transcript_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=27489 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=269409 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=1115959 DEFAULT CHARSET=latin1;
