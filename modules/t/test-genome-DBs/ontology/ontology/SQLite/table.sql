...
-- Created on Fri Oct 11 09:31:33 2013
-- 
...
--
CREATE TABLE alt_id (
  alt_id INTEGER PRIMARY KEY NOT NULL,
...
CREATE TABLE closure (
  closure_id INTEGER PRIMARY KEY NOT NULL,
...
CREATE TABLE ontology (
  ontology_id INTEGER PRIMARY KEY NOT NULL,
...
CREATE TABLE relation_type (
  relation_type_id INTEGER PRIMARY KEY NOT NULL,
  name varchar(64) NOT NULL
);
...
--
CREATE TABLE subset (
  subset_id INTEGER PRIMARY KEY NOT NULL,
  name varchar(64) NOT NULL,
