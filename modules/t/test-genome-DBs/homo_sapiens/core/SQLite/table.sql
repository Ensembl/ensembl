...
-- Created on Wed Jul 31 15:08:18 2013
-- 
...
CREATE TABLE alt_allele (
  ...
  is_ref tinyint NOT NULL DEFAULT 0
);

CREATE UNIQUE INDEX allele_idx ON alt_allele (alt_allele_id, gene_id);
...
--
CREATE TABLE dna (
  seq_region_id INTEGER PRIMARY KEY NOT NULL DEFAULT 0,
...
CREATE TABLE dna_align_feature (
  ...
  external_data text,
  pair_dna_align_feature_id integer
);
...
CREATE TABLE external_db (
  external_db_id INTEGER PRIMARY KEY NOT NULL DEFAULT 0,
...
CREATE TABLE identity_xref (
  object_xref_id INTEGER PRIMARY KEY NOT NULL DEFAULT 0,
...
--
CREATE TABLE qtl (
  qtl_id INTEGER PRIMARY KEY NOT NULL,
  trait varchar(255) NOT NULL DEFAULT '',
  lod_score float,
  flank_marker_id_1 integer,
  flank_marker_id_2 integer,
  peak_marker_id integer
);
...
CREATE TABLE qtl_feature (
  ...
  seq_region_start integer NOT NULL DEFAULT 0,
  seq_region_end integer NOT NULL DEFAULT 0,
  qtl_id integer NOT NULL DEFAULT 0,
  analysis_id integer NOT NULL DEFAULT 0
);
...
CREATE TABLE qtl_synonym (
  qtl_synonym_id INTEGER PRIMARY KEY NOT NULL,
  qtl_id integer NOT NULL DEFAULT 0,
  source_database enum NOT NULL DEFAULT 'rat genome database',
