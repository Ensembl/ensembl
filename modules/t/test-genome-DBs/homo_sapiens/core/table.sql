...
) ENGINE=MyISAM AUTO_INCREMENT=555 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
) ENGINE=MyISAM AUTO_INCREMENT=625 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
) ENGINE=MyISAM AUTO_INCREMENT=29797248 DEFAULT CHARSET=latin1 COLLATE=latin1_bin MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=18294 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=196 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
CREATE TABLE `prediction_transcript` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`),
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=18086 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
CREATE TABLE `protein_align_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `external_db_idx` (`external_db_id`)
) ENGINE=MyISAM AUTO_INCREMENT=11554509 DEFAULT CHARSET=latin1 COLLATE=latin1_bin MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
CREATE TABLE `protein_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=242849 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
) ENGINE=MyISAM AUTO_INCREMENT=1022 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
CREATE TABLE `repeat_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=922517 DEFAULT CHARSET=latin1 COLLATE=latin1_bin MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=1000009 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
