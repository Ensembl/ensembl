...
) ENGINE=MyISAM AUTO_INCREMENT=100000189 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `genomic_align` (
  ...
  KEY `node_id` (`node_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6770002296671 DEFAULT CHARSET=latin1 MAX_ROWS=1000000000 AVG_ROW_LENGTH=60 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `genomic_align_block` (
  ...
  KEY `method_link_species_set_id` (`method_link_species_set_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6770001148336 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
...
) ENGINE=MyISAM AUTO_INCREMENT=114 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=36174 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `synteny_region` (
  ...
  KEY `method_link_species_set_id` (`method_link_species_set_id`)
) ENGINE=MyISAM AUTO_INCREMENT=51494 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
