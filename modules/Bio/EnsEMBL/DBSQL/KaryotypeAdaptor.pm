...
#
# Ensembl module for Bio::EnsEMBL::DBSQL::KaryotypeAdaptor
#
...
Bio::EnsEMBL::DBSQL::KaryotypeAdaptor - DESCRIPTION of Object
...
package Bio::EnsEMBL::DBSQL::KaryotypeAdaptor;
use vars qw(@ISA);
use strict;
