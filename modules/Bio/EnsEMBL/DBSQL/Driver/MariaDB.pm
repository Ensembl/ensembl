...
package Bio::EnsEMBL::DBSQL::Driver::MariaDB;
...
#
# override parent's method to enable MySQL local load data in case DBD::MariaDB 
...
sub connect_params {
  ...
  $params->{attributes}{mariadb_local_infile} = 1;
  $params->{attributes}{mariadb_server_prepare} = 1;
  $params->{attributes}{mariadb_max_allowed_packet} = 1*1024*1024*1024;
