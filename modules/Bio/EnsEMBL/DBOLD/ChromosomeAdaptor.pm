...
#
# Ensembl module for Bio::EnsEMBL::DBOLD::ChromosomeAdaptor
#
...
Bio::EnsEMBL::DBOLD::ChromosomeAdaptor - DESCRIPTION of Object
...
package Bio::EnsEMBL::DBOLD::ChromosomeAdaptor;
use vars qw(@ISA);
use strict;
