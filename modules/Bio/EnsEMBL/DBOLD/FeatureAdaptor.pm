#
# EnsEMBL module for Bio::EnsEMBL::DBOLD::FeatureAdaptor
#
...
Bio::EnsEMBL::DBOLD::FeatureAdaptor - MySQL database adapter class for EnsEMBL Feature Objects
...
package Bio::EnsEMBL::DBOLD::FeatureAdaptor;
...
use Bio::EnsEMBL::DBOLD::RawContigAdaptor;
use DBI;
