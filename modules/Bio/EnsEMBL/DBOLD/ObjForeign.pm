# EnsEMBL module for Bio::EnsEMBL::DBOLD::Foreign
#
...
=head1 SYNOPSIS
  ...
  $db = new Bio::EnsEMBL::DBOLD::Obj( -user => 'root'
                                      , -db => 'pog' 
                                      , -host => 'caldy' 
                                      , -driver => 'mysql' );
...
package Bio::EnsEMBL::DBOLD::ObjForeign;
...
sub _read_db_obj {
    ...
    if( defined $value) {
        my $needed = 'Bio::EnsEMBL::DBOLD::Obj';
