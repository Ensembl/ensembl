...
export PERL5LIB=$PERL5LIB:$ENSDIR/bioperl-live:$ENSDIR/ensembl-test/modules:$PWD/modules:$ENSDIR/ensembl-io/modules:$ENSDIR/ensembl-variation/modules:$ENSDIR/ensembl-compara/modules:$PWD/misc-scripts/xref_mapping
...
if [ "$COVERALLS" = 'true' ]; then
  ...
  perl $ENSDIR/ensembl-test/scripts/runtests.pl -v modules/t $SKIP_TESTS
  rt=$?
  if [ "$DB" = 'mysql' ]; then
